...
public class HelloControllerIntegrationTest {
    ...
    @Test
    void helloGibran() {
        ResponseEntity<String> responseEntity = restTemplate.getForEntity("http://localhost:" + port + "/hello?name=Gibran", String.class);
        String response = responseEntity.getBody();

        Assertions.assertNotNull(response);
        Assertions.assertEquals("Hello Gibran", response.trim());
    }
}
